...
tools/absgenftml.py -q -t 'Kern Data with Marks(auto)' source/masters/Lateef-Regular.ufo  tests/KernData.ftml        -l logs/KernData.log         --prevfont references/LateefGR-1.200.ttf -s 'url(../references/LateefGR-1.200.ttf)=LateefGR' --ap "_?dia[AB]$" --xsl ../tools/ftml.xsl --scale 250 -i source/glyph_data.csv --langs "sd,ur,ku,rhg,ky" -w 75% -s 'url(../results/Lateef-ExtraLight.ttf)=ExLt' -s 'url(../results/Lateef-Regular.ttf)=Reg' -s 'url(../results/Lateef-ExtraBold.ttf)=ExBld' &
