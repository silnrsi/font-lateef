...
tools/absgenftml.py -q -t 'Subtending Marks (auto)' source/masters/Lateef-Regular.ufo  tests/SubtendingMarks.ftml -l logs/Subtending.log       -s 'local(Harmattan)=Har (inst)'                    --ap "_?dia[AB]$" --xsl ../tools/ftml.xsl --scale 250 -i source/glyph_data.csv --langs "sd,ur,ku,rhg,wo" -w 75% -s 'url(../results/Lateef-Regular.ttf)=Reg-Gr' -s 'url(../results/tests/ftml/fonts/Lateef-Regular_ot_arab.ttf)=Reg-OT' & # -s 'url(../results/Lateef-Bold.ttf)=Bold-Gr' &
